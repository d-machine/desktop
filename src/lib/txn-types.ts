...
export const TXN_TYPES: TxnTypeOption[] = [
  ...
  { value: "IPO",            label: "IPO Allotment",   defaultSegment: "DELIVERY",  showPrice: true,  showCharges: true  },
  { value: "FPO",            label: "FPO Allotment",   defaultSegment: "DELIVERY",  showPrice: true,  showCharges: true  },
  ...
  { value: "SPLIT_OUT",      label: "Split Out",       defaultSegment: "DELIVERY",  showPrice: false, showCharges: false },
  { value: "SPLIT_IN",       label: "Split In",        defaultSegment: "DELIVERY",  showPrice: false, showCharges: false },
  ...
  { value: "BF",             label: "Brought Forward", defaultSegment: "FNO",       showPrice: true,  showCharges: false },
  { value: "CF",             label: "Carried Forward", defaultSegment: "FNO",       showPrice: true,  showCharges: false },
];
...
export const TXN_TYPE_COLORS: Record<string, string> = {
  ...
  IPO:             "text-blue-600 dark:text-blue-400",
  FPO:             "text-blue-600 dark:text-blue-400",
  ...
  SPLIT_OUT:       "text-orange-600 dark:text-orange-400",
  SPLIT_IN:        "text-purple-600 dark:text-purple-400",
